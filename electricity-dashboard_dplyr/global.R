...
elec_data <- readRDS(file = "datas/elec_energy.rds")
share_data <- readRDS(file = "datas/share_energy.rds")
bin_data <- readRDS(file = "datas/bin_energy.rds")
elec_data_pivoted <- readRDS(file = "datas/elec_energy_pivoted.rds") 
pre_elec_data_pivoted <- readRDS(file = "datas/pre_elec_energy_pivoted.rds") 
cons_data <- readRDS(file = "datas/cons_energy.rds")
stats_datf <- read.table(file = "datas/stats.csv", sep = ",", header = TRUE)
imp_data <- readRDS(file = "datas/imp_data.rds")
indiv_data <- readRDS(file = "datas/indiv_data.rds")
filtered_elec_data_pivoted <- readRDS(file = "datas/filtered_elec_energy_pivoted.rds")
